...
def get_place_of_interest(Data_File):
    target_file = os.path.join(HERE, Data_File)
        ...
        with open(target_file, 'r') as f:
            ...
            for line in f.readlines():
                ...
                if match_result:
                    ...
                    description = match_result.group(3)
                    RESULT[line_counter] = [the_location, description]
                    line_counter += 1
        return RESULT
    import sys
    sys.exit("Illegal places file name") 
